...
class Emerald
{
    ...
    public function getEmeForm(Player $player)
    {
        $form = new SimpleForm(function(Player $player, $data) {
            ...
            switch ($data) {
                ...
                case 1: // sno1
                    $armor = [VanillaItems::NETHERITE_HELMET(), VanillaItems::NETHERITE_CHESTPLATE(), VanillaItems::NETHERITE_LEGGINGS(), VanillaItems::NETHERITE_BOOTS()];
                    foreach($armor as $item){
                        LibTrimArmor::create($item, MaterialType::EMERALD, PatternType::SNOUT);
                        $player->getInventory()->addItem($item);
                    }
                ...
                case 2: // dm
                    $armor = [VanillaItems::NETHERITE_HELMET(), VanillaItems::NETHERITE_CHESTPLATE(), VanillaItems::NETHERITE_LEGGINGS(), VanillaItems::NETHERITE_BOOTS()];
                    foreach($armor as $item){
                        LibTrimArmor::create($item, MaterialType::EMERALD, PatternType::VEX);
                        $player->getInventory()->addItem($item);
                    }
                ...
                case 3: // eme
                    $armor = [VanillaItems::NETHERITE_HELMET(), VanillaItems::NETHERITE_CHESTPLATE(), VanillaItems::NETHERITE_LEGGINGS(), VanillaItems::NETHERITE_BOOTS()];
                    foreach($armor as $item){
                        LibTrimArmor::create($item, MaterialType::EMERALD, PatternType::WILD);
                        $player->getInventory()->addItem($item);
                    }
                ...
                case 4: // gold
                    $armor = [VanillaItems::NETHERITE_HELMET(), VanillaItems::NETHERITE_CHESTPLATE(), VanillaItems::NETHERITE_LEGGINGS(), VanillaItems::NETHERITE_BOOTS()];
                    foreach($armor as $item){
                        LibTrimArmor::create($item, MaterialType::EMERALD, PatternType::DUNE);
                        $player->getInventory()->addItem($item);
                    }
                ...
                case 5: // iron
                    $armor = [VanillaItems::NETHERITE_HELMET(), VanillaItems::NETHERITE_CHESTPLATE(), VanillaItems::NETHERITE_LEGGINGS(), VanillaItems::NETHERITE_BOOTS()];
                    foreach($armor as $item){
                        LibTrimArmor::create($item, MaterialType::EMERALD, PatternType::RIB);
                        $player->getInventory()->addItem($item);
                    }
