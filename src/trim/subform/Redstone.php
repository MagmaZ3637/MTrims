...
class Redstone
{
    ...
    public function getRedForm(Player $player)
    {
            ...
            switch ($data) {
                case 0: // sil1
                    ...
                    foreach($armor as $item){
                        LibTrimArmor::create($item, MaterialType::REDSTONE, PatternType::SILENCE);
                ...
                case 1: // sno1
                    $armor = [VanillaItems::NETHERITE_HELMET(), VanillaItems::NETHERITE_CHESTPLATE(), VanillaItems::NETHERITE_LEGGINGS(), VanillaItems::NETHERITE_BOOTS()];
                    foreach($armor as $item){
                        LibTrimArmor::create($item, MaterialType::REDSTONE, PatternType::SNOUT);
                        $player->getInventory()->addItem($item);
                    }
                ...
                case 2: // dm
                    $armor = [VanillaItems::NETHERITE_HELMET(), VanillaItems::NETHERITE_CHESTPLATE(), VanillaItems::NETHERITE_LEGGINGS(), VanillaItems::NETHERITE_BOOTS()];
                    foreach($armor as $item){
                        LibTrimArmor::create($item, MaterialType::REDSTONE, PatternType::VEX);
                        $player->getInventory()->addItem($item);
                    }
                ...
                case 3: // eme
                    $armor = [VanillaItems::NETHERITE_HELMET(), VanillaItems::NETHERITE_CHESTPLATE(), VanillaItems::NETHERITE_LEGGINGS(), VanillaItems::NETHERITE_BOOTS()];
                    foreach($armor as $item){
                        LibTrimArmor::create($item, MaterialType::REDSTONE, PatternType::WILD);
                        $player->getInventory()->addItem($item);
                    }
                ...
                case 4: // gold
                    $armor = [VanillaItems::NETHERITE_HELMET(), VanillaItems::NETHERITE_CHESTPLATE(), VanillaItems::NETHERITE_LEGGINGS(), VanillaItems::NETHERITE_BOOTS()];
                    foreach($armor as $item){
                        LibTrimArmor::create($item, MaterialType::REDSTONE, PatternType::DUNE);
                        $player->getInventory()->addItem($item);
                    }
                ...
                case 5: // iron
                    $armor = [VanillaItems::NETHERITE_HELMET(), VanillaItems::NETHERITE_CHESTPLATE(), VanillaItems::NETHERITE_LEGGINGS(), VanillaItems::NETHERITE_BOOTS()];
                    foreach($armor as $item){
                        LibTrimArmor::create($item, MaterialType::REDSTONE, PatternType::RIB);
                        $player->getInventory()->addItem($item);
                    }
